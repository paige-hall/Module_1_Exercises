...
public class Exercises {
    ...
    public String firstHalf(String str) {
        int halfWayString = str.length() / 2;
        return str.substring(0, halfWayString);
    }
    ...
    public String nonStart(String a, String b) {
        String aAndB = a.substring(1, a.length()) + b.substring(1, b.length());
        return aAndB;
    }
    ...
    public boolean hasBad(String str) {
        if (str.length() < 3) {
            return false;
        } else if (str.substring(0, 3).equals("bad") || (str.length() >= 4) && str.substring(1, 4).equals("bad")) {
            return true;
        } else {
            return false;
        }
